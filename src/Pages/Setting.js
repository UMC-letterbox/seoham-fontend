    ...
    return(
        <div>
            <div className="flex justify-around pt-8 mb-2.5">
                <button onClick={onClick}><img src="/img/left-arrow.png" className="w-4 h-4"/></button>
                <h1>설정</h1>
                <span></span>
            </div>
            ...
            <div className="text-center my-10">
                <h3 className="">글꼴</h3>
                <SettingBtn text={"아리따 부리"} textClassName={"buri"} setFont={setFont}/>
                <SettingBtn text={"이롭게 바탕체"} textClassName={"Iropke"} setFont={setFont}/>
                <SettingBtn text={"조선일보명조"} textClassName={"Chosun"} setFont={setFont}/> {/**조선일보명조가 디코딩이 안돼서 일단 조선굵은명조로 넣었습니다.*/}
                <SettingBtn text={"Mapo 금빛나루"} textClassName={"Mapo"} setFont={setFont}/>
            </div>
