...
function Modal_password({modalClose}) {
    ...
    return (
        <div className='modal_container' onClick={onCloseModal}>
            <div className='modal w-10/12 rounded-xl shadow-md px-8 py-4'>
                <h1 className="mb-7 mt-2 text-lg buri">비밀번호 변경</h1>
                <div>
                <input className="w-10/12 border-b-2 mt-3 mr-1 buri"
                            name="new_password"
                            placeholder="새 비밀번호"
                            value= {new_pass}
                ...
                <input className="w-10/12 border-b-2 mt-6 mr-1 buri"
                            name="new2_password"
                            placeholder="비밀번호 확인"
                            value= {new2_pass}
                ...
                <div className='flex justify-center'>
                    <button className='bg-[#EF9F9F] rounded-full mt-6 py-3 px-5 text-white buri'
