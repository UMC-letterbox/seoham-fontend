...
function Modal({modalClose, modalCheck, setSelected}){
    ...
    return (
        <div className='modal_container' onClick={onCloseModal}>
            <div className='modal w-10/12 h-2/6 rounded-xl shadow-md'>
                ...
                <div className='flex justify-center mt-5 p-3'>
                    <select
                        ...
                        className="w-1/4 h-10 text-center border-y-2 border-[#989898] m-2"
                    >
                        {years.map(item => (
                ...
                <div className='modal_button'>
                    <button className='p-3' onClick={modalClose}>취소</button>
                    <button className='p-3 text-[#EF9F9F]' onClick={onCheckModal}>확인</button>
                </div>
            </div>
        </div>
    );
